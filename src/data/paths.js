    ...
    core: [
      {
        ...
        echoes: [
          { path: 'dao', slug: 'shobogenzo', title: 'Shōbōgenzō', note: 'To forget the self in the act—here made plainly first-person.' },
          { path: 'dao', slug: 'three-zen-sutras', title: 'Three Zen Sutras', note: 'No-self asserted in the sutras, here simply seen.' },
          { path: 'zion', slug: 'zhuangzi', title: 'The Complete Zhuangzi', note: "'I have lost myself,' says the sage—the dissolving of the separate self." },
        ],
      },
      {
        ...
        epithet: 'Attention Turned Around',
        ...
        echoes: [
          { path: 'de', slug: 'on-having-no-head', title: 'On Having No Head', note: 'The same seeing, given its experiments and proofs.' },
          { path: 'dao', slug: 'shobogenzo', title: 'Shōbōgenzō', note: 'To study the self until the self is forgotten.' },
          { path: 'de', slug: 'alan-watts', title: 'The Alan Watts Collection', note: 'Awareness grown aware of itself, in the Western ear.' },
        ],
      },
      {
        slug: 'the-prophet',
        ...
        epithet: 'Work Is Love Made Visible',
        quote: {
          text: 'Work is love made visible.',
          cite: 'Kahlil Gibran, The Prophet',
        },
        ...
        echoes: [
          { path: 'dao', slug: 'sermon-on-the-mount', title: 'The Sermon on the Mount', note: 'Trust and love spoken in image rather than precept.' },
          { path: 'dao', slug: 'lieh-tzu', title: 'The Book of Lieh-tzu', note: 'Wisdom carried in parable and story.' },
          { path: 'zion', slug: 'sri-chaitanya', title: 'Sri Chaitanya and His Associates', note: 'Love made the discipline and the way.' },
        ],
      },
      {
        slug: 'golden-flower',
        ...
        href: '',
        epithet: 'Circulating the Light',
        quote: {
          text: 'The Golden Flower is the light; when the light is made to circulate, the energies of heaven and earth crystallize.',
          cite: 'The Secret of the Golden Flower',
        },
        ...
        echoes: [
          { path: 'dao', slug: 'daodejing', title: 'Daodejing', note: 'Wu wei turned inward—letting the light move of itself.' },
          { path: 'de', slug: 'science-of-the-first-person', title: 'The Science of the 1st Person', note: 'Attention turned to face its own source.' },
          { path: 'dao', slug: 'shobogenzo', title: 'Shōbōgenzō', note: 'Practice as the light that realization gives.' },
        ],
      },
    ],
    further: [
      {
        ...
        epithet: 'The Universe Knowing Itself',
        quote: {
        ...
        echoes: [
          { path: 'de', slug: 'on-having-no-head', title: 'On Having No Head', note: 'No separate self to defend—seeing it for oneself.' },
          { path: 'dao', slug: 'daodejing', title: 'Daodejing', note: 'The watercourse way—moving with, not against.' },
          { path: 'dao', slug: 'gateless-gate', title: 'The Gateless Gate', note: 'The self-grasping thought, loosened.' },
        ],
      },
      {
        slug: 'iron-john',
        ...
        epithet: 'The Wound and the Gift',
        quote: {
          text: "Where a man's wound is, that is where his genius will be.",
          cite: 'Robert Bly',
        },
        ...
        echoes: [
          { path: 'zion', slug: 'jesus-the-christ', title: 'Jesus the Christ', note: 'Descent, wound, and return—the redemptive pattern.' },
          { path: 'de', slug: 'the-prophet', title: 'The Prophet', note: 'The inner life told as story and image.' },
        ],
      },
    ],
  },
    ...
    core: [
      {
        ...
        echoes: [
          { path: 'zion', slug: 'torah', title: 'The Torah', note: 'Another covenant record of a people bound by promise.' },
          { path: 'dao', slug: 'sermon-on-the-mount', title: 'The Sermon on the Mount', note: 'The same Sermon, given again at Bountiful.' },
          { path: 'zion', slug: 'pearl-of-great-price', title: 'Pearl of Great Price', note: "Enoch's Zion—the archetype of the order made whole." },
        ],
      },
      {
        slug: 'torah',
        ...
        echoes: [
          { path: 'zion', slug: 'book-of-mormon', title: 'The Book of Mormon', note: 'A second witness of covenant and a people.' },
          { path: 'zion', slug: 'analects', title: 'The Analects of Confucius', note: 'Law and rite as the form that holds a people together.' },
          { path: 'dao', slug: 'sermon-on-the-mount', title: 'The Sermon on the Mount', note: 'The law not abolished but fulfilled and transfigured.' },
        ],
      },
      {
        slug: 'analects',
        ...
        echoes: [
          { path: 'zion', slug: 'torah', title: 'The Torah', note: 'Law and ritual as the ordering of a people.' },
          { path: 'dao', slug: 'shobogenzo', title: 'Shōbōgenzō', note: 'The rite itself as the teaching—the act before the doctrine.' },
          { path: 'zion', slug: 'book-of-mormon', title: 'The Book of Mormon', note: 'A people ordered by covenant and relation.' },
        ],
      },
      {
        slug: 'zhuangzi',
        ...
        href: '',
        epithet: 'The Holy Fool',
        quote: {
          text: 'Now I do not know whether I was a man dreaming I was a butterfly, or am now a butterfly dreaming I am a man.',
          cite: 'Zhuangzi, ch. 2 (Watson)',
        },
        ...
        echoes: [
          { path: 'dao', slug: 'daodejing', title: 'Daodejing', note: 'The Way the order must not forget—wu wei at play.' },
          { path: 'dao', slug: 'lieh-tzu', title: 'The Book of Lieh-tzu', note: 'Kindred Taoist tales of ease and the forgotten self.' },
          { path: 'de', slug: 'on-having-no-head', title: 'On Having No Head', note: "'I have lost myself'—the self that order keeps trying to fix." },
        ],
      },
    ],
    further: [
      {
        ...
        echoes: [
          { path: 'zion', slug: 'book-of-mormon', title: 'The Book of Mormon', note: 'The covenant continued; Zion built and gathered.' },
          { path: 'zion', slug: 'torah', title: 'The Torah', note: 'Moses and the creation—the cosmogony of a people.' },
          { path: 'dao', slug: 'daodejing', title: 'Daodejing', note: 'The generative source from which the worlds proceed.' },
        ],
      },
      {
        ...
        epithet: 'The Life That Founds the Covenant',
        ...
        echoes: [
          { path: 'zion', slug: 'book-of-mormon', title: 'The Book of Mormon', note: 'The same Christ, testified by another witness.' },
          { path: 'dao', slug: 'sermon-on-the-mount', title: 'The Sermon on the Mount', note: 'His teaching—the Way he gave to walk.' },
          { path: 'de', slug: 'iron-john', title: 'Iron John', note: 'Descent, wound, and return—the redemptive pattern in story.' },
        ],
      },
      {
        slug: 'sri-chaitanya',
        ...
        epithet: 'The Discipline of Love',
        why: 'A devotional order formed around shared ecstatic practice—community as the vessel and discipline of love.',
        echoes: [
          { path: 'zion', slug: 'jesus-the-christ', title: 'Jesus the Christ', note: 'Devotion gathered around a divine person.' },
          { path: 'de', slug: 'the-prophet', title: 'The Prophet', note: 'Love made the path and the practice.' },
        ],
      },
    ],
  },
